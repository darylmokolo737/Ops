...
def section4():
    ...
    mypets = {'Mido': 'cat', 'dog': 'Timber', 'mouse': 'Whiskers'}                                                              for k, v in mypets.items():
        print(k + ' is my ' + v)
...
def section5() 
    ...
    print(res)
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          def section6():
    print('### Section 6')
    print("### Should print 'Ports scanned: 1000 total ports'")                                                                  print('Ports scanned: ' + RESULTS['stats']['scanner'])
    ...
    for ports in RESULTS['152.157.64.5']['ports']:
        print('Service ' + ports['service']['name'] + ' on port ' + ports['portid'])                                                                                                                                                                       # Run main() if the script is called directly
